...
class IServAPI:
    ...
    def send_email(
        ...
        Args:
            receiver_email (str or list): The email address(es) of the recipient(s). Can be a single email string or a list of email strings.
        ...
        # Normalize receiver_email to a list
