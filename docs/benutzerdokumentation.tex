...
\begin{enumerate}[leftmargin=1.5em]
    ...
    \item Entpacke das Archiv: \texttt{tar -xzf KuchenApp-linux.tar.gz}
...
\textbf{Statuszeile} & Zeigt Erfolgs- bzw. Fehlermeldungen an. \\
\bottomrule
\end{tabularx}
\end{center}
...
Bei erfolgreichem Versand erscheint die Statusmeldung
\emph{"`Mails sent successfully."'} in der unteren Statuszeile.
\end{successbox}
...
Kopfzeile besitzt. Die Statuszeile zeigt im Fehlerfall \emph{"`Import failed"'}
oder \emph{"`No file selected"'} an.
